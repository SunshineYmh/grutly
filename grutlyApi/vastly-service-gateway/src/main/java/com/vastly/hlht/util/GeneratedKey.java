...
public class GeneratedKey {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(generatedKey.generatorKey());
       /* System.out.println(generatedKey.getMachineIdentifier());
        System.out.println(generatedKey.getProcessIdentifier());
        System.out.println(generatedKey.getProjectIdentifier());*/
    }
