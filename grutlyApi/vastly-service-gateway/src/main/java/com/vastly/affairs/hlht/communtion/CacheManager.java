...
public class CacheManager {
    ...
    /** 缓存项最大数量 */
    private static long GUAVA_CACHE_SIZE = 1000;

    /** 缓存时间：秒*/
    private static  long GUAVA_CACHE_SECONDS = 1800;

    @Value("${com.shineyue.fabric.cache_guava_size:1000}")
    public void setCache_guava_size(long cache_guava_size) {
        GUAVA_CACHE_SIZE = cache_guava_size;
    }

    @Value("${com.shineyue.fabric.cache_guava_time:3600}")
    public void setCache_guava_time(long cache_guava_time) {
        GUAVA_CACHE_SECONDS = cache_guava_time;
        try {
